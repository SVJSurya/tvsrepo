...
async def payments_page():
    ...
    <body>
        ...
        <script>
            ...
            function resendLink(paymentId) {
                ...
                modal.innerHTML = `
                    <div style="background: white; padding: 30px; border-radius: 12px; max-width: 500px; width: 90%;">
                        <h3 style="margin-top: 0; color: #2a5298;">🔄 Resend Payment Link</h3>
                        <p>Enter the email address to resend the payment link:</p>
                        <input type="email" id="resend-email" placeholder="customer@example.com" 
                               style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 6px; margin: 10px 0;">
                        <div style="margin-top: 20px; display: flex; gap: 10px; justify-content: flex-end;">
                            ...
                            <button onclick="sendResendRequest('${paymentId}')" 
                ...
                // Handle Enter key
                document.getElementById('resend-email').addEventListener('keypress', (e) => {
                    if (e.key === 'Enter') sendResendRequest(paymentId);
                });
            ...
            async function sendResendRequest(paymentId) {
                ...
                try {
                    const response = await fetch('/api/payment/send-link', {
                        ...
                        body: JSON.stringify({
                            ...
                            customer_name: extractCustomerName(email),
                    ...
                    if (result.success) {
                        ...
                        showNotification(`✅ Payment link resent successfully to ${email}`, 'success');
                        closeResendModal();
                        ...
                        throw new Error(result.message || 'Failed to resend payment link');
                    }
                } catch (error) {
