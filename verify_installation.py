...
def check_environment_file():
    ...
    try:
        ...
        critical_vars = ["GOOGLE_API_KEY", "GMAIL_USER", "GMAIL_APP_PASSWORD"]
        ...
        if missing_vars:
            print(
                test_color(
                    f"\n💡 Configure these variables in .env for full functionality",
                    "yellow",
                )
            )
...
def test_google_ai_connection():
    ...
    try:
        ...
        try:
            ...
            print(
                test_color(
                    "💡 Try: pip install --upgrade google-generativeai", "yellow"
                )
            )
            return False
...
def main():
    ...
    if passed_tests == total_tests:
        ...
        print(
            test_color("🔧 Please fix the issues and run the verification again", "red")
        )
